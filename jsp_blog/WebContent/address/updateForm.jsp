...
<h2 class="text-success">주소 변경</h2><br>
<FORM name='frm' method='POST' action='./updateProc.jsp' class="form-horizontal" onsubmit="return input(this)">
	...
	<input type="hidden" name="nowPage" value="<%=request.getParameter("nowPage")%>">
 	<div class="form-group">
      ...
      <div class="col-sm-6">
        <p class="form-control-static text-left"><%=dto.getName() %></p>
      </div>
    </div>
 	<div class="form-group">
      ...
      <div class="col-sm-6">
        ...
        placeholder="Enter phoneNumber" value="<%=dto.getPhone()%>">
      </div>
    </div>
 	<div class="form-group">
      ...
      <div class="col-sm-4">
       ...
       placeholder="Enter zipcode" value="<%=dto.getZipcode()%>">
      </div>     
    </div>
 	<div class="form-group">
