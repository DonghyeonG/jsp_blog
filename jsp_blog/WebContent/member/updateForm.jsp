...
<h2 class="text-success">회원 수정</h2><br>
<FORM name='frm' method='POST' action='./updateProc.jsp' class="form-horizontal" onsubmit="return inputCheck(this)">
...
<input type="hidden" name="word" value="<%=request.getParameter("word") %>">
 	<div class="form-group">
      ...
      <div class="col-sm-2">
        <p class="form-control-static text-left"><%=dto.getId() %></p>
      </div>
    </div>
 	<div class="form-group">
      <label class="control-label col-sm-3" for="mname">이름:</label>
      <div class="col-sm-6">
        <p class="form-control-static text-left"><%=dto.getMname() %></p>
      </div>
    </div>
 	<div class="form-group">
      ...
      <div class="col-sm-6">
        ...
        id="tel" placeholder="Enter phoneNumber" value="<%=dto.getTel()%>">
      </div>
    </div>
 	<div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        placeholder="Enter E-mail" value="<%=dto.getEmail()%>">
      </div>
      <div class="col-sm-1">
 	...
 	<div class="form-group">
      ...
      <div class="col-sm-4">
       <input type="text" name="zipcode" class="form-control" id="sample6_postcode" 
       placeholder="Enter postcode" value="<%=dto.getZipcode()%>">
      </div>     
    </div>
 	<div class="form-group">
      ...
      <div class="col-sm-6">
        ...
        placeholder="Enter address" value="<%=dto.getAddress1()%>">
        <input type="text" name="address2" class="form-control" id="sample6_address2" 
        placeholder="Enter address" value="<%=dto.getAddress2()%>">
      </div>
    </div>
 	<div class="form-group">
