...
<h2>
	<button class="text-left btn-block btn-inverse btn-lg"><i class="fa fa-user fa-fw w3-margin-right"></i>Agreement</button>
</h2><br>
...
<h2 class="text-success text-center">약관 동의</h2><br>
<form name="frm" method="post" action="./createForm.jsp"   onsubmit="return send();"> 

<table border="0" cellspacing="0" cellpadding="2"  align="center"> 
    <tr>  
        <td align="center"> 
            <textarea  class="form-control" cols="100" rows="20">Cummunity 서비스약관 (2005. 7. 18 부터 유효) 
...
본 약관은 2005. 7. 18. 부터 적용하고, 2004. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
  ...
  <label><input type="checkbox" name="agree" value="1" > 약관에 동의합니다</label><br>
