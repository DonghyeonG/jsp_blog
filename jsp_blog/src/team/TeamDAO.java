...
public class TeamDAO {
	...
	public boolean update(TeamDTO dto){
		...
		sql.append("update team set phone=?,zipcode=?,address1=?,address2=?,");
		sql.append("skill=?,hobby=? where no=?");
		try {
			pstmt=con.prepareStatement(sql.toString());
	...
	public TeamDTO read(int no){
		...
		sql.append("select no,name,gender,phone,zipcode,address1,address2,skill,hobby,filename from team where no=?");
		try {
			pstmt=con.prepareStatement(sql.toString());
			pstmt.setInt(1, no);
			rs=pstmt.executeQuery();
	...
	public String imgRead(int no){
		...
		sql.append("select filename from team where no=?");
		try {
			pstmt=con.prepareStatement(sql.toString());
			pstmt.setInt(1, no);
			rs=pstmt.executeQuery();
	...
	public boolean create(TeamDTO dto){
		...
		sql.append("insert into team(no,name,gender,phone,zipcode,address1,address2,skill,hobby,filename)");
